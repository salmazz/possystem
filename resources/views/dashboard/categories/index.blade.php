    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-header p-3 with-border">
              ...
              <h3 class="box-title" style="margin-bottom: 15px">@lang('site.categories') <small>{{ $categories->total() }}</small>
                </h3> 
        ...
        <td>{{$category->name}}</td>
      <td>
    <a class="btn btn-info btn-sm" style="display:inline-block" href="{{route('dashboard.categories.edit',$category->id)}}">
