                ...
                {{ method_field('put') }}
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                        <img src="{{$user->image_path}}" alt="" class="img-fluid img-preview" style="width:100px">
                        </div>
                        <div class="form-group">
                ...
                <div class="card-body">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane  {{$index == 0 ? 'active' : ' '}}" id="{{$model}}">
                      ...
                      <input type="checkbox"  name="permissions[]" {{$user->hasPermission($map . '_' . $model) ? 'checked' : ''}} class="form-check-input" value="{{$map . '_' . $model}}" id="exampleCheck1">
